...
export function typescript(options: TypeScriptOptions = {}): Linter.Config[] {
  ...
  return defineConfig({
    ...
    rules: {
      '@typescript-eslint/no-unsafe-return': 'warn', // Too noisy, especially with complex types and type inference
      '@typescript-eslint/no-unsafe-call': 'warn', // Too noisy, especially with complex types and type inference
