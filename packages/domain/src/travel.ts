...
export type FlightExtractionMethod = z.infer<typeof FlightExtractionMethodSchema>
...
export type FlightProcessingStatus = z.infer<typeof FlightProcessingStatusSchema>
...
export const FlightSyncJobStatusSchema: ZodType<FlightSyncJobStatus>
  = z.object({
    id: z.string(),
    userId: z.string(),
...
export const UpdateFlightActivityInputSchema = z.object({
...
export type UpdateFlightActivityInput = z.infer<typeof UpdateFlightActivityInputSchema>
